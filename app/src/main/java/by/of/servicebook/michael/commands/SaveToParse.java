package by.of.servicebook.michael.commands;
...
import by.of.servicebook.michael.db.DataProvider;
import by.of.servicebook.michael.db.models.Car;
import by.of.servicebook.michael.db.models.Detail;
import by.of.servicebook.michael.db.models.Job;
import by.of.servicebook.michael.db.models.Record;
        ...
        try {
            ...
            for (Record rec: records){
                ...
                for(Job job:jobList){
                    ...
                    ParseRelation<ParseDetail> jobToDetailRelation = parseJob.getRelation(ParseJob.DETAILS_RELATION);
